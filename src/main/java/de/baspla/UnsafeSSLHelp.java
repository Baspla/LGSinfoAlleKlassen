...
public class UnsafeSSLHelp {
    private static Log LOG = LogFactory.getLog(UnsafeSSLHelp.class.getName());
    private static boolean warnUnsecureMode = false;

    /**
     * This method could be called before asking "https://" uri to accept any
     * invalid ssl certificate.
     * <p>
     * src:
     * http://stackoverflow.com/questions/1828775/how-to-handle-invalid-ssl-
     * certificates-with-apache-httpclient
     * <p>
     * Usage
     * <p>
     * common usage sample: (new UnsafeSSLHelp()).ignoreSSLCertif(); // then
     * make your https connection
     * <p>
     * Apache HttpClient example: UnsafeSSLHelp unsafeSSLHelper = new
     * UnsafeSSLHelp(); CloseableHttpClient client = HttpClientBuilder .create()
